...
const loginButton = document.querySelector('.submit-login-form') as HTMLButtonElement;
...
setupValidation(passwordInput, passwordError, validatePassword, checkFormLoginValidity);
